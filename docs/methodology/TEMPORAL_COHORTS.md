...
Records opened from 2020-01-01 through 2026-07-31 were retrieved in August and
September 2026 and are classified as `retrospective_source_record`. They
support analysis of dates currently reported by Tampa, subject to coverage
discontinuities, but they are not historical snapshots. The record backfill
does not extend before January 2020. Records from 2026-08-01 onward are
