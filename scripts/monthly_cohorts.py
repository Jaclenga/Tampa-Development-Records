...
FIELD_METADATA = {
    ...
    "event_date": ("Selected source-derived date used to assign the record to an event cohort.", "date", "", "Blank when no supported source date is available.", "source/derived selection", "Source-specific hierarchy documented in docs/methodology/TEMPORAL_COHORTS.md.", "ISO 8601 date.", "Interpret only with event_date_type and event_date_basis; meanings differ across sources."),
